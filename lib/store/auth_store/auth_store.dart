...
abstract class _AuthStore with Store {
  ...
  @observable
  LoadingStatusEnum deleteUserState = LoadingStatusEnum.init;
  ...
  @action
  Future<void> deleteUserFunction(BuildContext context) async {
    deleteUserState = LoadingStatusEnum.loading;
    dynamic _resp = await _authProvider.deleteUser(accessToken);
    print(_resp);
    if (_resp['success'] == true) {
      deleteUserState = LoadingStatusEnum.success;
      ...
      deleteUserState = LoadingStatusEnum.error;
    }
  }
