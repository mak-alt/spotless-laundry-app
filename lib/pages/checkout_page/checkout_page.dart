...
class CheckoutPage extends StatefulWidget {
  ...
  const CheckoutPage({Key? key, this.fromQuickOrder = false}) : super(key: key);
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  final TextEditingController _orderDataController = TextEditingController();
          ...
          return SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    visible: widget.fromQuickOrder,
                    child: Container(
                      margin: EdgeInsets.only(bottom: 13.h, top: 13.h),
                      child: HeaderCard(
                        isMargin: false,
                        name: AppTranslations.of(context)!
                            .text('ORDER DETAILS', 'NOTES'),
                        actionName: AppTranslations.of(context)!.text('', ''),
                      ),
                    ),
                  ),
                  ...
                  Visibility(
                    visible: widget.fromQuickOrder,
                    child: TextField(
                      controller: _orderDataController,
                      decoration: InputDecoration(
                        ...
                        labelText: AppTranslations.of(context)!
                            .text('ORDER DETAILS', 'NOTESMESSAGE'),
        ...
        if (presentDate.compareTo(selectedDate!) == -1) {
          if (selectedTime != null) {
            CreateOrderDto _input = CreateOrderDto(
              ...
              orderDetails: null,
              notes: _orderDataController.text == ""
                  ? null
                  : _orderDataController.text,
            );
            _cartStore.createItemOrder(_input, context, _authStore.accessToken!,
                widget.fromQuickOrder);
          } else {
            BotToast.showText(
